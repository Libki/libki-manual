...
A Docker Compose file is provided at `docker/docker-compose.yml` which bring up both Libki Server and a MariaDB container.  Environment variables should be saved at `docker/.env`
