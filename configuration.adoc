...
To authorize your server to use the Cloud Print API:
...
To get your printer cloud id:
. Set up the printer for Google Cloud Print
. Browse to https://www.google.com/cloudprint/simulate.html
. Use the Printer Search API to search for you printers
.. Or browse to https://www.google.com/cloudprint/search directly
