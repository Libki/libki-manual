...
<8> Specify a SIP tag here that contains the user's date of birth  in the SIP user lookup response, default is 'PB'.  Some ILS, like Atriuum by Booksystems, use 'PD'.
